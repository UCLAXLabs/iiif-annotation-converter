...
def main(_):
  ...
  train_output_path = os.path.join(FLAGS.output_dir, 'edo_illustrations_train.record')
  val_output_path = os.path.join(FLAGS.output_dir, 'edo_illustrations_val.record')
